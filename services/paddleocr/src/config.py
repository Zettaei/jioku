from src.utils import load_config_yml
...
_config: dict = load_config_yml(APP_ENV)


_API_KEY = os.getenv("API_KEY", '')
HAS_API_KEY = not(_API_KEY == '')

WHITELISTED_IP: list = [ ip.strip() for ip in (os.getenv("WHITELISTED_IPS", '').split(','))]

LOGGER: dict = _config["logger"]
...
OCR: dict = {
    ...
    "OCR_MODELS": {
        ...
        # "doc_orientation_classify_model_dir": _MODEL_DIR / "PP-LCNet_x1_0_doc_ori_infer",
        
        # "doc_unwarping_model_name": "PP-LCNet_x1_0_doc_ori",
        # "doc_unwarping_model_dir": _MODEL_DIR / "PP-LCNet_x1_0_doc_ori_infer",
        
        # "text_detection_model_name": "PP-OCRv5_server_det",
        # "text_detection_model_dir": _MODEL_DIR / "PP-OCRv5_server_det_infer",
        
        # "textline_orientation_model_name": "PP-OCRv5_server_rec",
        # "textline_orientation_model_dir": _MODEL_DIR / "PP-OCRv5_server_rec_infer",
        # textline_orientation_batch_size: Any | None = None,

        # "text_recognition_model_name": "UVDoc",
        # "text_recognition_model_dir": _MODEL_DIR / "UVDoc_infer",
...
__all__ = ["LOGGER", "OCR", "WHITELISTED_IP", "HAS_API_KEY"]